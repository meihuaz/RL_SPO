...
from gym_rec.envs_zmh.env_25D_temperature_v2 import GridWorldEnv_25D_temperature
...
# model = MaskablePPO.load('/public/home/yangnan/zhaomeihua/code/stable-baselines3-contrib-master_v2/log/GridWorldEnv_25D_temperature/30_40_10/checkpoint_972000_1158.5923', env=env)

model = MaskablePPO.load('/public/home/yangnan/zhaomeihua/code/stable-baselines3-contrib-master_v2/log/GridWorldEnv_25D_temperature/30_40_5/checkpoint_252000_1040.5681', env=env)
...
for ep in range(1, total_test_episodes+1):
    ep_reward = 0
    # obs, _ = env.reset()
    # obs = np.load("/public/home/yangnan/zhaomeihua/code/stable-baselines3-contrib-master_v2/log/GridWorldEnv_25D_temperature/30_40_10/obs_972000_1158.5923.npy")  
    obs = np.load("/public/home/yangnan/zhaomeihua/code/stable-baselines3-contrib-master_v2/log/GridWorldEnv_25D_temperature/30_40_5/obs_252000_1040.5681.npy")  
    env.state = obs[0]
    reward_max = 0
    min_error = 1
    best_state = 0
    ...
    reconstructed_X = env.t_data_orig
...
if visu:
    ...
    for i in range(2):
        save_dir = 'save_img/temperature_25D_agent10/' + str(i) + "_fig.png"
        if not os.path.exists('save_img/temperature_25D_agent10/'):
            os.makedirs('save_img/temperature_25D_agent10/')
