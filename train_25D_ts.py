...
from gym_rec.envs_zmh.env_25D_ts_v2 import GridWorldEnv_25D_ts
...
env = GridWorldEnv_25D_ts(num_agents=num_agents, n_basis_modes_t = n_basis_modes_t, n_basis_modes_s = n_basis_modes_s, grid_size=grid_size)
 

base_dir = 'log/GridWorldEnv_25D_ts_ent/'+str(grid_size[0])+"_"+str(grid_size[1])+'_'+str(num_agents)+'/'
